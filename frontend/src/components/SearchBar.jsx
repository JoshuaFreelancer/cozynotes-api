  ...
  const noteTypes = [
    {
      id: "text",
      label: "Text",
      icon: <TextAlignLeft size={28} weight="duotone" />,
      theme: "bg-bento-sky border-[#9ABED7] text-sky-900",
    },
    {
      id: "todo",
      label: "Tasks",
      icon: <CheckSquare size={28} weight="duotone" />,
      theme: "bg-bento-mint border-[#8DCAC0] text-emerald-900",
    },
    {
      id: "journal",
      label: "Journal",
      icon: <Calendar size={28} weight="duotone" />,
      theme: "bg-bento-lavender border-[#C4B2E0] text-violet-900",
    },
    {
      id: "media",
      label: "Media",
      icon: <Image size={28} weight="duotone" />,
      theme: "bg-bento-peach border-[#DBA19C] text-rose-900",
    },
  ];
      ...
      */}
      ...
      >
        <MagnifyingGlass
          size={20}
          weight="bold"
          className="text-slate-400 absolute left-4"
        />
        <input
          type="text"
      ...
      {isOpen && (
        <div className="absolute top-[calc(100%+12px)] left-0 w-full bg-[#F7F6F3] border-2 border-slate-200 rounded-3xl shadow-2xl p-5 flex flex-col gap-6 animate-in slide-in-from-top-2 fade-in duration-200">
          {/* SECTION: Note Types */}
          <div>
